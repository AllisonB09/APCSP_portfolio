...
#Init
# Applicant Names
names = ["Alice W.", "Bob J.", "Charlie M.", "David L.", "Eve S.", "Frank K.", "Grace H.", "Heidi V.", "Ivan Q.", "Judy P.",
...
experience = [2, 8, 5, 12, 1, 6, 9, 3, 10, 4, 0, 7, 15, 2, 8, 4, 11, 6, 3, 9,
...
expertise = ["Python Developer", "Java Expert", "Game Coder", "AI Specialist", "App Creator", "Cyber Security", "Robot Builder", "Web Designer", "Java Developer", "Python Coder",
...
#Func
def manager(years,title):
    #Step 1: Create the loop
    for i in range(len(names)):
        #Step 2: The conditional statement
        if title in expertise[i] and years >= 5:
            #Step 3: Add the correct item to filter list
            filtered_applicants.append(names[i])
    #Step 4: Analyze the result and clear filtered list
    print(filtered_applicants)
    filtered_applicants.clear()

#Main
manager(5,"Python")
manager(5,"Cyber Security")
